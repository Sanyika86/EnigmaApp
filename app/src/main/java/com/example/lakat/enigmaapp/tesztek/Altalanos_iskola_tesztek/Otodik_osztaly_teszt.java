...
import com.example.lakat.enigmaapp.tesztek.Kerdesek.Questions5;

import java.util.Random;

public class Otodik_osztaly_teszt extends AppCompatActivity {

    Button answer1, answer2, answer3, answer4;

    TextView score, question;

    private Questions5 mQuestions = new Questions5();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_otodik_osztaly_teszt);
    ...
    private void gameover(){
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Otodik_osztaly_teszt.this);
        alertDialogBuilder.setMessage("Vége a tesztnek, " + mScore +  " pontot szereztél!")
                ...
                .setPositiveButton("Új teszt indítása", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(getApplicationContext(), Otodik_osztaly_teszt.class));
                    }
                })
