...
import com.example.lakat.enigmaapp.tesztek.Kerdesek.Questions4;

import java.util.Random;

public class Negyedik_osztaly_teszt extends AppCompatActivity {

    Button answer1, answer2, answer3, answer4;

    TextView score, question;

    private Questions4 mQuestions = new Questions4();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_negyedik_osztaly_teszt);
    ...
    private void gameover(){
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Negyedik_osztaly_teszt.this);
        alertDialogBuilder.setMessage("Vége a tesztnek, " + mScore +  " pontot szereztél!")
                ...
                .setPositiveButton("Új teszt indítása", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(getApplicationContext(), Negyedik_osztaly_teszt.class));
                    }
                })
