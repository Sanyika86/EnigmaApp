...
public class Elso_osztaly_teszt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elso_teszt);
    ...
    private void gameover(){
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Elso_osztaly_teszt.this);
        alertDialogBuilder.setMessage("Vége a tesztnek, " + mScore +  " pontot szereztél!")
                ...
                .setPositiveButton("Új teszt indítása", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(getApplicationContext(), Elso_osztaly_teszt.class));
                    }
                })
