...
import com.example.lakat.enigmaapp.tesztek.Kerdesek.Questions3;

import java.util.Random;

public class Harmadik_osztaly_teszt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_harmadik_osztaly_teszt);
    ...
    private void gameover(){
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Harmadik_osztaly_teszt.this);
        alertDialogBuilder.setMessage("Vége a tesztnek, " + mScore +  " pontot szereztél!")
                ...
                .setPositiveButton("Új teszt indítása", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(getApplicationContext(), Harmadik_osztaly_teszt.class));
                    }
                })
