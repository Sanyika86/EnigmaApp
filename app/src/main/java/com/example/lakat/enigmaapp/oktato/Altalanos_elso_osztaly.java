        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                switch (i){
                    ...
                    case 6:
                        videoView.setVideoURI(Uri.parse("https://firebasestorage.googleapis.com/v0/b/enigma-2a729.appspot.com/o/osszeadas_harmas_szint.mp4?alt=media&token=01756564-5fa2-404b-b3f2-84a32339eb05"));break;
                    case 7:
                        videoView.setVideoURI(Uri.parse("https://firebasestorage.googleapis.com/v0/b/enigma-2a729.appspot.com/o/osszeadas_negyes_szint.mp4?alt=media&token=25afb159-fe4f-4847-9da7-d70dec0b9d74"));break;
                    case 8:
                        videoView.setVideoURI(Uri.parse("https://firebasestorage.googleapis.com/v0/b/enigma-2a729.appspot.com/o/kivonas_harmas_szint_elso_resz.mp4?alt=media&token=5035783d-094d-4569-ad4f-d3552891a9b0"));break;
                    case 9:
                        videoView.setVideoURI(Uri.parse("https://firebasestorage.googleapis.com/v0/b/enigma-2a729.appspot.com/o/kivonas_harmas_szint_masodik_resz.mp4?alt=media&token=cc3d2405-2da9-41db-aa54-aba5c766f94d"));break;
                    case 10:
                        videoView.setVideoURI(Uri.parse("https://firebasestorage.googleapis.com/v0/b/enigma-2a729.appspot.com/o/miert_mukodik_a_kolcsonzes.mp4?alt=media&token=feb30254-c13c-480e-8cbf-33160ddc512a"));break;
                    case 11:
                        videoView.setVideoURI(Uri.parse("https://firebasestorage.googleapis.com/v0/b/enigma-2a729.appspot.com/o/egyszeri_atcsoportositas_elso_pelda.mp4?alt=media&token=74594021-c72f-4bc4-8ab5-86e69aadb3f1"));break;
                    case 12:
                        videoView.setVideoURI(Uri.parse("https://firebasestorage.googleapis.com/v0/b/enigma-2a729.appspot.com/o/egyszeri_atcsoportositas_masodik_pelda.mp4?alt=media&token=382cc5bb-c408-49c7-ace6-c9e8c86e2bba"));break;
                    case 13:
                        videoView.setVideoURI(Uri.parse("https://firebasestorage.googleapis.com/v0/b/enigma-2a729.appspot.com/o/ketszeres_csoportositas.mp4?alt=media&token=0a4ce04c-5b28-402b-bd42-f0e18c9092ac"));break;
                    case 14:
                        videoView.setVideoURI(Uri.parse("https://firebasestorage.googleapis.com/v0/b/enigma-2a729.appspot.com/o/fejben_szamolos_kivonas.mp4?alt=media&token=054d8336-3b4c-46e5-af37-4499ded8867c"));break;
                    case 15:
                        videoView.setVideoURI(Uri.parse("https://firebasestorage.googleapis.com/v0/b/enigma-2a729.appspot.com/o/kivonas_negyes_szint.mp4?alt=media&token=fae69e08-5d85-4137-bc28-e8758f47f55a"));break;
                    case 16:
                        videoView.setVideoURI(Uri.parse("https://firebasestorage.googleapis.com/v0/b/enigma-2a729.appspot.com/o/kivonas_szoveges_feladat.mp4?alt=media&token=c91144be-a8be-495b-bdb2-a9ffe3bc689b"));break;
